...
import {ActiveStatus, ColumnMeta, Product} from '@/types';
import {DataTableColumnFiltersProps} from '@/components/common/data-table/data-table-column-filters';

const defaultStatusFilter: ProductsFilterValues["statusFilters"] = {
...
export function DataTableColumnFilters({
                                           ...
                                           filter,
                                           onFilterChange
                                       }: DataTableColumnFiltersProps<Product, ProductsFilterValues>) {
    ...
    const [statusFilters, setStatusFilters] = useState<ProductsFilterValues["statusFilters"]>(
    ...
    const getColumnHeader = (column: Column<Product>) => {
    ...
    const triggerFilterChange = (
        ...
        statusFilters?: ProductsFilterValues["statusFilters"],
    ) => {
        if (onFilterChange) {
